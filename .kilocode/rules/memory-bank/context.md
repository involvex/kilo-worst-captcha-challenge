...
- [x] Image-grid CAPTCHA verification component

## Current Structure

| File/Directory | Purpose | Status |
|----------------|---------|--------|
| `src/app/page.tsx` | Home page (renders CAPTCHA) | ✅ Ready |
| `src/app/layout.tsx` | Root layout | ✅ Ready |
| `src/app/globals.css` | Global styles | ✅ Ready |
| `src/components/Captcha.tsx` | Image-grid CAPTCHA component | ✅ Ready |
